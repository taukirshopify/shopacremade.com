  ...
  theme.OptionManager = new function () {
    ...
    _.initProductOptions = function ($productForm) {
      ...
      $productForm.find(_.selectors.multiOption).on('change.themeProductOptions', function () {
        ...
        //Target elemnts
        const cartBtn = document.querySelector('.button-add-cart')
        const customBtn = document.querySelector('.button-custom-shipping')

        //COnditionally display add to cart based on weight 
        if(variant.weight >= 2260000) {
